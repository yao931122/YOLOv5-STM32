...
def smart_inference_mode(torch_1_9=False): # 🚀 直接讓它強制為 False
    ...
    def decorate(fn):
        ...
        # 🚀 這裡原本是 return (torch.inference_mode if torch_1_9 else torch.no_grad)()(fn)
        # 徹底移除不相容的 inference_mode，改回最經典、穩定的舊版相容加速模式
